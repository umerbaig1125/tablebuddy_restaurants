      ...
      if (this.state.avatarSource == require('../Assets/userIcon1.png')) {
        fetch('http://' + global.AmeIp + '//api/Resturant/SaveResturantInfo/', {
          ...
          .then(responseJson => {
            ...
            console.log('2')
            console.log("Name")
            console.log(this.ResturantName)
            console.log("PhoneNumber")
            console.log(this.RphoneNumber)
            console.log("InaugrationDate")
            console.log(this.RInaugurationYear)
            console.log("DinningStyle")
            console.log(this.RDiningStyle)
            ...
            console.log(this.RMaxTable)
            console.log("MinTableSize")
            console.log(this.RMinTable)
            console.log("EstimatesWait")
            console.log(this.state.chosenEstimateTime)
            console.log("InitialSetup")
            console.log("1")
            console.log("StreetAddress")
            console.log(this.RStreetAddress)
            console.log("ZipCode")
            console.log(this.RZipCode)
            console.log("City")
            console.log(this.RCity)
            console.log("Country")
            console.log(this.RCountry)
            console.log("CuisineType")
            console.log(this.state.cuisineTypes)
            console.log("Service")
            console.log(this.state.SelectedServices)
            console.log("Day")
            console.log(this.state.SelectDays)
            console.log("DeviceToken")
            console.log(this.state.Dtoken)
            this.setState({
              loading: true,
            });
